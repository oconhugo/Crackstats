...
// accept the acceptance of a team 
	...
	$query_insert_into_standings = "INSERT INTO t_team_stats (League,Team,Games_Won,Games_Drawn,Games_Lost,Num_Games,Points,GF,GA) VALUES ('$league','$team','0','0','0','0','0','0','0')";
	...
	$results4 = mysqli_query($conn, $query_insert_into_standings);
