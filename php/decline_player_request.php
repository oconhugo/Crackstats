...
// decline the acceptance of a player to a team
	...
	$query_send_notification = "INSERT INTO t_notifications (Message,Sender,Receiver,Type_Of_Request,Team,League) VALUES ('Your request to join $team has been denied','$user_email','$player_email',0,'$team','$league')";
